...
const config: Config = {
  title: 'GH Templates',
  tagline: 'CLI tool for managing GitHub templates (ISSUE, PR, LICENSE, etc.)',
  ...
  projectName: 'gh-templates', // Repository name
  ...
  presets: [
    [
      'classic',
      {
        ...
        //   },
        //   editUrl:
        //     'https://github.com/rafaeljohn9/gh-templates/tree/main/blog/',
        //   onInlineTags: 'warn',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub Issues',
              href: 'https://github.com/rafaeljohn9/gh-templates/issues',
            },
            // {
            //   label: 'Discord',
      ...
      copyright: `Copyright © ${new Date().getFullYear()} gh-templates.`,
    },
    prism: {
