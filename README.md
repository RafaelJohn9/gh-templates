...
To install the latest version (`v0.0.38`), download the appropriate binary for your platform from the [v0.0.38 release page](https://github.com/RafaelJohn9/gh-templates/releases/tag/v0.0.41).
...
```sh
wget https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.41/gh-templates-x86_64-unknown-linux-gnu
...
```sh
wget https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.41/gh-templates-x86_64-unknown-linux-musl
...
```sh
wget https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.41/gh-templates-aarch64-unknown-linux-gnu
...
```sh
curl -LO https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.41/gh-templates-aarch64-apple-darwin
...
```sh
curl -LO https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.41/gh-templates-x86_64-apple-darwin
...
Invoke-WebRequest -Uri "https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.41/gh-templates-x86_64-pc-windows-gnu.exe" -OutFile "$env:USERPROFILE\bin\gh-templates.exe"
```
