...
```sh
wget https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.44/gh-templates-x86_64-unknown-linux-gnu
...
```sh
wget https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.44/gh-templates-x86_64-unknown-linux-musl
...
```sh
wget https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.44/gh-templates-aarch64-unknown-linux-gnu
...
```sh
curl -LO https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.44/gh-templates-aarch64-apple-darwin
...
```sh
curl -LO https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.44/gh-templates-x86_64-apple-darwin
...
Invoke-WebRequest -Uri "https://github.com/RafaelJohn9/gh-templates/releases/download/v0.0.44/gh-templates-x86_64-pc-windows-gnu.exe" -OutFile "$env:USERPROFILE\bin\gh-templates.exe"
```
